...
import { CardContent, Typography, Avatar, Grid, CardMedia, Stack, Tooltip, Chip, Box } from '@mui/material';
                    ...
                    <BlankCard className="hoverCard">
                        <>
                            <Typography component={Link} href="/">
                                <CardMedia component="img" height="240" image={author.coveravatar} alt="green iguana" />
                            </Typography>
                            <CardContent>
