...
const ChatListing = () => {
    ...
    const filterChats = (chats: ChatsType[], cSearch: string) => {
        if (chats) return chats.filter((t) => t.name.toLocaleLowerCase().includes(cSearch.toLocaleLowerCase()));
        ...
        <div>
            ...
            <Box display={'flex'} alignItems="center" gap="10px" p={3}>
                <Badge
                    ...
                    color="success"
                >
                    <Avatar alt="Remy Sharp" src="/images/profile/user-1.png" sx={{ width: 54, height: 54 }} />
                </Badge>
                <Box>
